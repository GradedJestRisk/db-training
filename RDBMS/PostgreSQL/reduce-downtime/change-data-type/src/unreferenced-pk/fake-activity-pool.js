...
const queryAgainstTableWhoseDataTypeIsToBeChanged = async (pool) => {
  ...
  if (process.env.CHANGE_SCOPE === 'UNREFERENCED_FK') {
    queries = queriesUnreferencedPK;
  } else {
    queries = queriesReferencedPK;
  }
